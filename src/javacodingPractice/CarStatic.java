...
public class CarStatic {
	...
	public static void main(String[] args) {
		...
		System.out.println(wheels);// can be  called directly 
		start();
		// 2. should be called by className.
		System.out.println(CarStatic.wheels); // can be  called by class name
		CarStatic.start();
		...
		c1.price = 70;
		c1.color = "Black";
		c1.wheels = 4;// warning  - not the recommended way 
		...
		c1.steering();
		c1.start(); // warning - not the recommended way
